...
public class OperatingSystem {
    ...
    public OperatingSystem(String s) {
        for (int value : imgContent) {
            imgByteToWrite.add(value);
        }
    ...
    public static void main(String[] args) {
        OperatingSystem op = new OperatingSystem("hello, this is my first line of my operating system code by liangyehao");
        op.makeFloppy();
